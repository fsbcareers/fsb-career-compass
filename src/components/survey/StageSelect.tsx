            ...
            return (
              <div key={bucket.id} className="relative">
                ...
                >
                  ...
                  >
                    {getIcon(bucket.icon, bucket.id === "already_done" ? 24 : 22)}
                  </span>
                  ...
                  <div className="pl-[30px] flex flex-col gap-[8px]">
                    {bucketStages.map((stage, idx) => (
                      <button
                        ...
                        className={`relative flex items-center w-full text-left min-h-[56px] py-3 px-4 rounded-xl border-2 transition-all duration-150 active:scale-[0.96]
                          ${
                            isExpanded
